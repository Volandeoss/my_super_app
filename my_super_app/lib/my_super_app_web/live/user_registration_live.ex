defmodule MySuperAppWeb.UserRegistrationLive do
  ...
  def mount(_params, _session, socket) do
    changeset = AccountsAuth.change_user_registration(%User{})
  ...
  def handle_event("save", %{"user" => user_params}, socket) do
    case AccountsAuth.register_user(user_params) do
      {:ok, user} ->
        {:ok, user}
        # {:ok, _} =
        #   AccountsAuth.deliver_user_confirmation_instructions(
        #     user,
  ...
  def handle_event("validate", %{"user" => user_params}, socket) do
    changeset = AccountsAuth.change_user_registration(%User{}, user_params)
